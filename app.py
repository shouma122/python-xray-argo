...
UUID = os.environ.get('UUID', '20e6e496-cf19-45c8-b883-14f5e11cd8f1')  # UUID,如使用哪吒v1,在不同的平台部署需要修改,否则会覆盖
...
ARGO_DOMAIN = os.environ.get('ARGO_DOMAIN', 'sap.tech8.tech')        # Argo固定隧道域名,留空即使用临时隧道
ARGO_AUTH = os.environ.get('ARGO_AUTH', 'eyJhIjoiODYyMmRlNmEyYTk3OGJjMjNmMzAxOTZlZWVlNTk4MzgiLCJ0IjoiNWQ0NzViYjctODI4NS00NTNlLWE0ZDItNWFmNmMwZTdhOTFiIiwicyI6IlpUa3hOamszTkdZdE1EQmtOUzAwWWpaa0xXRXhaRFV0WVRReE1tUmhaR0U1TnpFNCJ9')            # Argo固定隧道密钥,留空即使用临时隧道
